...
if (!class_exists('Musicwhore_Artist_Connector_Settings')) {
	class Musicwhore_Artist_Connector_Settings {
		...
		public function admin_init() {
			...
			add_settings_section('musicwhore_artist_connector-section', 'Musicwhore Artist Connector', array(&$this, 'render_settings_section_description'), 'musicwhore_artist_connector');

			add_settings_field('musicwhore_artist_connector-db_host', 'Database host', array(&$this, 'render_settings_input_text_field'), 'musicwhore_artist_connector', 'musicwhore_artist_connector-section', array('field' => 'musicwhore_db_host'));
			add_settings_field('musicwhore_artist_connector-db_name', 'Database name', array(&$this, 'render_settings_input_text_field'), 'musicwhore_artist_connector', 'musicwhore_artist_connector-section', array('field' => 'musicwhore_db_name'));
			add_settings_field('musicwhore_artist_connector-db_user', 'Database user', array(&$this, 'render_settings_input_text_field'), 'musicwhore_artist_connector', 'musicwhore_artist_connector-section', array('field' => 'musicwhore_db_user'));
			add_settings_field('musicwhore_artist_connector-db_password', 'Database password', array(&$this, 'render_settings_input_password_field'), 'musicwhore_artist_connector', 'musicwhore_artist_connector-section', array('field' => 'musicwhore_db_password'));
		}
