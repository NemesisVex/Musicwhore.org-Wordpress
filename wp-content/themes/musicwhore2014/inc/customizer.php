 ...
 */
function musicwhore2014_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'featured_content_layout', array(
		'default'           => 'grid',
		'sanitize_callback' => 'musicwhore2014_sanitize_layout',
	) );
...
add_action( 'customize_register', 'musicwhore2014_customize_register' );
 ...
 */
function musicwhore2014_sanitize_layout( $layout ) {
 ...
 * @since Musicwhore2014 1.0
 */
function musicwhore2014_customize_preview_js() {
	wp_enqueue_script( 'musicwhore2014_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20131205', true );
}
add_action( 'customize_preview_init', 'musicwhore2014_customize_preview_js' );
 ...
 * @since Musicwhore2014 1.0
 */
function musicwhore2014_contextual_help() {
...
add_action( 'admin_head-themes.php', 'musicwhore2014_contextual_help' );
add_action( 'admin_head-edit.php',   'musicwhore2014_contextual_help' );
