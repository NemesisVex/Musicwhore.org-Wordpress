...
?>
	...
	?>
				...
				<div class="entry-content">
					<div class="entry-attachment">
						<div class="attachment">
							<?php musicwhorearchive_the_attached_image(); ?>
						</div><!-- .attachment -->
			...
			<nav id="image-navigation" class="navigation image-navigation">
				<div class="nav-links">
				<?php previous_image_link( false, '<div class="previous-image">' . __( 'Previous Image', 'musicwhorearchive' ) . '</div>' ); ?>
				<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'musicwhorearchive' ) . '</div>' ); ?>
				</div><!-- .nav-links -->
